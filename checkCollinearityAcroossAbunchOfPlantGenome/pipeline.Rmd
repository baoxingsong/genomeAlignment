...
wget ftp://ftp.ensemblgenomes.org/pub/plants/release-49/fasta/solanum_lycopersicum/dna/Solanum_lycopersicum.SL3.0.dna.toplevel.fa.gz # tomato
...
minimap2 -x splice -t 11 -k 12 -a -p 0.4 -N 20 Solanum_lycopersicum.SL3.0.dna.toplevel.fa tair10_cds.fa > ara.tomato.sam
minimap2 -x splice -t 11 -k 12 -a -p 0.4 -N 20 Solanum_lycopersicum.SL3.0.dna.toplevel.fa maize_cds.fa > maize.tomato.sam
...
anchorwave proali -i TAIR10_GFF3_genes.gff -r tair10.fa -as tair10_cds.fa -a ara.tomato.sam -ar tair10.sam -s Solanum_lycopersicum.SL3.0.dna.toplevel.fa -n ara_tomato.anchorspro -ns -R 3 -Q 4
