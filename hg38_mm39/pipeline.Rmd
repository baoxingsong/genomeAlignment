...
samtools depth mm39.bam | wc -l   # 2626401667
samtools depth mm39.bam | awk '$3>0 {print $0}' | wc -l # 898282066

samtools depth mm39_noY.bam | wc -l  # 2619366741
samtools depth mm39_noY.bam | awk '$3>0 {print $0}' | wc -l  # 898205502
...
samtools depth mm392.bam | wc -l   # 2615637279
samtools depth mm392.bam | awk '$3>0 {print $0}' | wc -l # 892068996

samtools depth mm392_noY.bam | wc -l  # 2615637279
samtools depth mm392_noY.bam | awk '$3>0 {print $0}' | wc -l  # 892068996
...
samtools depth -b encodeCcreCombined_merged.bed mm392_noY.bam | wc -l  # 234830066
samtools depth -b encodeCcreCombined_merged.bed mm392_noY.bam | awk '$3>0 {print $0}' | wc -l  # 121152422
